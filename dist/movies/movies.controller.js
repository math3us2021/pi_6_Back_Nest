...
const pub_sub_service_1 = require("../pub-sub/pub-sub.service");
let MoviesController = class MoviesController {
    constructor(moviesService, pubSubService) {
    ...
    create(createMovieDto) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (createMovieDto) {
                yield this.pubSubService.publishMessage('register_movie', JSON.stringify(createMovieDto));
            }
            return createMovie;
        });
    }
